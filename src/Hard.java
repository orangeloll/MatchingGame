...
public class Hard extends JFrame{
	...
	ImageIcon img7= new ImageIcon("images/테스트7.jpg");
	ImageIcon img8= new ImageIcon("images/테스트8.jpg");
	ImageIcon img9= new ImageIcon("images/테스트9.jpg");
	ImageIcon img10= new ImageIcon("images/테스트10.jpg");
	ImageIcon img11= new ImageIcon("images/테스트11.jpg");
	ImageIcon img12= new ImageIcon("images/테스트12.jpg");
    ImageIcon images[]= {img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12,img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12};
	...
	public Hard() {
        ...
        JLabel label=new JLabel("<html>사과, 수박, 바나나, 포도, 귤, 키위<br> 감, 딸기, 참외, 체리, 파인애플, 멜론 맞추기 </html>");
        label.setSize(400,100);
        label.setLocation(20, 20);
        mainscreen.setSize(120,40);
        mainscreen.setBackground(Color.WHITE);
        mainscreen.setLocation(450, 20);
        ...
        for(int i=0;i<24;i++){
            ...
            if(i<=5) button[i].setBounds(x,130,150,200);
            else if(i>6&&i<=12) {
               ...
               x2+=160;
            	...
            	button[i].setBounds(x4,760,150,200);
            	x4+=160;
            }
            x+=160;
